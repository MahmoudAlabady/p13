...
// echo $categories['subCategories']['samsung'][0]->name;
// print_r($categories['subCategories']['samsung'][1]->madeIn[1]);
// echo $categories['subCategories']['apple'][1]->colors[1]->secondaryColors[1];
